...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=HIVE_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=HIVE_BUILD_ID");
    println!("cargo:rerun-if-env-changed=HIVE_BUILD_COMMIT");
